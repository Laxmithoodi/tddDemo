...
import Arrays.RandomUtils;
import Arrays.StringUtils;
...
public final class PersonFactory {
    ...
    public static List<Person> createPersonList(int listSize) {
        ...
        List<Person> people = Stream.generate(PersonFactory::createRandomPerson).limit(listSize)
    ...
    public static Person[] createPersonArray(int arrayLength) {
        Person[] people = Stream.generate(PersonFactory::createRandomPerson).limit(arrayLength).toArray(Person[] ::new);
        return people;
    }
